...
#if PROJECT_STM32CUBE_BUG_WORKAROUNDS == 1
	//#define PSRAM_CONFIG_STM_EXT_MEMMANAGER           // memtest fails, wait for fix from ST
	#define PSRAM_CONFIG_STM_EXAMPLE_PSRAM_MEM_MAPPED   // see Projects/STM32N6570-DK/Examples/XSPI/XSPI_PSRAM_MemoryMapped
#else
	#define PSRAM_CONFIG_STM_EXT_MEMMANAGER           // memtest fails, wait for fix from ST
	//#define PSRAM_CONFIG_STM_EXAMPLE_PSRAM_MEM_MAPPED   // see Projects/STM32N6570-DK/Examples/XSPI/XSPI_PSRAM_MemoryMapped
#endif
...
/** @defgroup EXTMEM_CONF_Exported_constants EXTMEM_CONF exported constante
  ...
  */
enum {
  EXTMEM_SPI_FLASH  = 0, /*!< ID 0 of extmem_list_config */
  EXTMEM_SPI_RAM    = 1, /*!< ID 1 of extmem_list_config */
};
/**
  * @}
  */

#define EXTMEM_MEMORY_BOOTXIP  EXTMEM_SPI_FLASH
