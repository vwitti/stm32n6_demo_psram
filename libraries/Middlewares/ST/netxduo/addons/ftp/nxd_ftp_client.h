...
#ifndef NX_FTP_SERVER_CONTROL_PORT
	//This is some sort of hack to make port configurable
	extern UINT App_NetXDuo_GetFTP_Server_Port();
	#define NX_FTP_SERVER_CONTROL_PORT		App_NetXDuo_GetFTP_Server_Port()
