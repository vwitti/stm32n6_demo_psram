...
/* For supporting BSD sockets in ThreadX we need to define an additional member in the ThreadX thread state struct
   see ../Doku/ThreadX/rtos-docs/netx-duo/netx-duo-bsd/chapter2.md */
