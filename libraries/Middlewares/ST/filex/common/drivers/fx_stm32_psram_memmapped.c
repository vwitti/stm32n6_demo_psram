...
UCHAR *sram_disk_end = ((UCHAR *)(FX_PSRAM_DISK_BASE_ADDRESS + FX_PSRAM_DISK_SIZE));
    ...
    switch (media_ptr->fx_media_driver_request)
    {
        ...
        case FX_DRIVER_INIT:
        {
            ...
            if (is_initialized == 0)
            {
                _fx_utility_memory_set((UCHAR *)FX_PSRAM_DISK_BASE_ADDRESS, '\0', FX_PSRAM_DISK_SIZE);
                is_initialized = 1;
            }
        ...
        case FX_DRIVER_READ:
        {
            ...
            source_buffer = ((UCHAR *)FX_PSRAM_DISK_BASE_ADDRESS) +
        ...
        {
            /* Calculate the RAM disk sector offset */
            destination_buffer =  (UCHAR *)FX_PSRAM_DISK_BASE_ADDRESS +
                                  ((media_ptr->fx_media_driver_logical_sector +  media_ptr->fx_media_hidden_sectors) * media_ptr->fx_media_bytes_per_sector);
