...
// In appli we have a dedicated are for the frame buffer, see STM32N6577XX_XIP.ld
// NOTE: Address and size of FBRAM must be in sync
#define LCD_LAYER_0_ADDRESS                 0x34146000
#define LCD_LAYER_1_ADDRESS                 0x34206000
#endif
