...
/** 
  ******************************************************************************
  * @file    Examples_LL/TIM/TIM_DMA_Init/Src/stm32n6xx_it.c
...
void GPDMA1_Channel0_IRQHandler(void)
{
  ...
  else if((LL_DMA_IsActiveFlag_USE(GPDMA1, LL_DMA_CHANNEL_0) == 1) ||
          (LL_DMA_IsActiveFlag_ULE(GPDMA1, LL_DMA_CHANNEL_0) == 1) ||
          (LL_DMA_IsActiveFlag_DTE(GPDMA1, LL_DMA_CHANNEL_0) == 1))
  {
