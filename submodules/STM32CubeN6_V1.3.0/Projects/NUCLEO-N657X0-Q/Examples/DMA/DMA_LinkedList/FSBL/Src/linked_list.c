...
DMA_NodeTypeDef Node1 __NON_CACHEABLE;
DMA_QListTypeDef Queue;
DMA_NodeTypeDef Node2 __NON_CACHEABLE;
DMA_NodeTypeDef Node3 __NON_CACHEABLE;
...
uint32_t aDST_Buffer1[BUFFER1_SIZE] __NON_CACHEABLE;
uint32_t aDST_Buffer2[BUFFER2_SIZE] __NON_CACHEABLE;
uint32_t aDST_Buffer3[BUFFER3_SIZE] __NON_CACHEABLE;
/* USER CODE END PM */
