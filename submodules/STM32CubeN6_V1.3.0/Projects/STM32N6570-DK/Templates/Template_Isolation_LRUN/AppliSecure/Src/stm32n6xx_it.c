...
typedef void (CMSE_NS_CALL *SecureFaultCallback)(void);
typedef void (CMSE_NS_CALL *SecureErrorCallback)(void);
typedef void (CMSE_NS_CALL *SecureITCallback)(IRQn_Type IrqLine);
#else
typedef void CMSE_NS_CALL (*SecureFaultCallback)(void);
typedef void CMSE_NS_CALL (*SecureErrorCallback)(void);
typedef void CMSE_NS_CALL (*SecureITCallback)(IRQn_Type IrqLine);
