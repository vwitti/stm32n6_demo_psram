...
#define USBD_UVC_INTERFACE_STRING                     "STM32 H264 video Streaming"
...
#define UVC_CAM_FPS_FS                                25U
#define UVC_CAM_FPS_HS                                25U
...
#define VC_HEADER_SIZE                                (sizeof(USBD_VIDEOCSVCIfDescTypeDef) + \
                                                       sizeof(USBD_VIDEOInputTerminalDescTypeDef) + \
                                                       sizeof(USBD_VIDEOOutputTerminalDescTypeDef))
#define VS_HEADER_SIZE                                (sizeof(USBD_VIDEOVSHeaderDescTypeDef) + \
                                                       sizeof(USBD_VIDEOPayloadFormatDescTypeDef) + \
