...
#define UCPDDMA_INSTANCE0_REQUEST_RX   GPDMA1_REQUEST_UCPD_RX
...
#define UCPDDMA_INSTANCE0_REQUEST_TX   GPDMA1_REQUEST_UCPD_TX
...
#define UCPDFRS_INSTANCE0_FRSCC1                                                      \
  ...
  {                                                                                   \
    ...
    LL_GPIO_SetAFPin_0_7(GPIOC, LL_GPIO_PIN_8, LL_GPIO_AF_6);                       \
  } while(0)
...
#define UCPDFRS_INSTANCE0_FRSCC2                                                      \
  ...
  {                                                                                   \
    ...
    LL_GPIO_SetAFPin_0_7(GPIOC, LL_GPIO_PIN_9, LL_GPIO_AF_6);                       \
  } while(0)
