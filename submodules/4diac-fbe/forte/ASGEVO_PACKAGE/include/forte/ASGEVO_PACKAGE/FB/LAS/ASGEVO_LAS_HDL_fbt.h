...
namespace forte::ASGEVO_PACKAGE::FB::LAS {
  class FORTE_ASGEVO_LAS_HDL final : public CSimpleFB {
      DECLARE_FIRMWARE_FB(FORTE_ASGEVO_LAS_HDL)
    ...
    private:
      ...
      CInternalFB<forte::ASGEVO_PACKAGE::FB::LAS::FORTE_ASGEVO_LAS_HDL_OP> fb_FB_LAS_HDL_OP;
      void alg_REQ(void);
    ...
    public:
      FORTE_ASGEVO_LAS_HDL(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_UINT &paSTATE, const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_INPUTS &paINPUT, const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_PARAMETER &paPARAM, const CIEC_UINT &paTARGET, CAnyBitOutputParameter<CIEC_BOOL> paDONE, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS> paOUTPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_TIMING> paTIMING, COutputParameter<CIEC_UINT> paERRCODE) {
      ...
      void operator()(const CIEC_UINT &paSTATE, const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_INPUTS &paINPUT, const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_PARAMETER &paPARAM, const CIEC_UINT &paTARGET, CAnyBitOutputParameter<CIEC_BOOL> paDONE, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS> paOUTPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_TIMING> paTIMING, COutputParameter<CIEC_UINT> paERRCODE) {
        evt_REQ(std::forward<const CIEC_UINT &>(paSTATE), std::forward<const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_INPUTS &>(paINPUT), std::forward<const forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_PARAMETER &>(paPARAM), std::forward<const CIEC_UINT &>(paTARGET), std::forward<CAnyBitOutputParameter<CIEC_BOOL>>(paDONE), std::forward<COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS>>(paOUTPUT), std::forward<COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_TIMING>>(paTIMING), std::forward<COutputParameter<CIEC_UINT>>(paERRCODE));
      }
  };
}
