...
namespace forte::ASGEVO_PACKAGE::FB::PUSH {
  class FORTE_ASGEVO_PUSH_HDL final : public CSimpleFB {
      DECLARE_FIRMWARE_FB(FORTE_ASGEVO_PUSH_HDL)
    ...
    private:
      ...
      CInternalFB<forte::ASGEVO_PACKAGE::FB::PUSH::FORTE_ASGEVO_PUSH_HDL_OP> fb_FB_LAS_HDL_OP;
      void alg_REQ(void);
    ...
    public:
      FORTE_ASGEVO_PUSH_HDL(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const CIEC_UINT &paSTATE, const forte::ASGEVO_PACKAGE::FB::PUSH::CIEC_INPUTS_PUSH &paINPUT, CAnyBitOutputParameter<CIEC_BOOL> paDONE, COutputParameter<CIEC_UINT> paERRCODE, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS> paOUTPUT) {
      ...
      void operator()(const CIEC_UINT &paSTATE, const forte::ASGEVO_PACKAGE::FB::PUSH::CIEC_INPUTS_PUSH &paINPUT, CAnyBitOutputParameter<CIEC_BOOL> paDONE, COutputParameter<CIEC_UINT> paERRCODE, COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS> paOUTPUT) {
        evt_REQ(std::forward<const CIEC_UINT &>(paSTATE), std::forward<const forte::ASGEVO_PACKAGE::FB::PUSH::CIEC_INPUTS_PUSH &>(paINPUT), std::forward<CAnyBitOutputParameter<CIEC_BOOL>>(paDONE), std::forward<COutputParameter<CIEC_UINT>>(paERRCODE), std::forward<COutputParameter<forte::ASGEVO_PACKAGE::FB::LAS::CIEC_LAS_OUTPUTS>>(paOUTPUT));
      }
  };
}
