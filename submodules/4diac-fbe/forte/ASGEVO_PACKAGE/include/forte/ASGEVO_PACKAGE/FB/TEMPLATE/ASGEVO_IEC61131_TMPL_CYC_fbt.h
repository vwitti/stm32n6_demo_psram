...
namespace forte::ASGEVO_PACKAGE::FB::TEMPLATE {
  class FORTE_ASGEVO_IEC61131_TMPL_CYC final : public CBasicFB {
      DECLARE_FIRMWARE_FB(FORTE_ASGEVO_IEC61131_TMPL_CYC)
    ...
    private:
      ...
      CInternalFB<forte::ASGEVO_PACKAGE::FB::TEMPLATE::FORTE_ASGEVO_IEC61131_TEMPL_HDL> fb_FB_HANDLER;
    ...
    public:
      FORTE_ASGEVO_IEC61131_TMPL_CYC(StringId paInstanceNameId, CFBContainer &paContainer);
      ...
      void evt_REQ(const forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_INPUTS_IEC61131_TMPL &paINPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_OUTPUTS_IEC61131_TMPL> paOUTPUT, COutputParameter<CIEC_UINT> paERRCODE) {
      ...
      void evt_ABORT(const forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_INPUTS_IEC61131_TMPL &paINPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_OUTPUTS_IEC61131_TMPL> paOUTPUT, COutputParameter<CIEC_UINT> paERRCODE) {
        COutputGuard guard_OUTPUT(paOUTPUT);
        COutputGuard guard_ERRCODE(paERRCODE);
        var_INPUT = paINPUT;
      ...
      void evt_IDLE(const forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_INPUTS_IEC61131_TMPL &paINPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_OUTPUTS_IEC61131_TMPL> paOUTPUT, COutputParameter<CIEC_UINT> paERRCODE) {
        COutputGuard guard_OUTPUT(paOUTPUT);
        COutputGuard guard_ERRCODE(paERRCODE);
        var_INPUT = paINPUT;
      ...
      void evt_FREEZE(const forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_INPUTS_IEC61131_TMPL &paINPUT, COutputParameter<forte::ASGEVO_PACKAGE::FB::TEMPLATE::CIEC_OUTPUTS_IEC61131_TMPL> paOUTPUT, COutputParameter<CIEC_UINT> paERRCODE) {
        COutputGuard guard_OUTPUT(paOUTPUT);
        COutputGuard guard_ERRCODE(paERRCODE);
        var_INPUT = paINPUT;
