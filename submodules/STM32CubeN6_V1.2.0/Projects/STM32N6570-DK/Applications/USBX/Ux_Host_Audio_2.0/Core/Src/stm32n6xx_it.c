...
/**
  * @brief This function handles EXTI line[13:10] interrupts.
  */
void EXTI13_IRQHandler(void)
{
  /* USER CODE BEGIN EXTI13_10_IRQn 0 */

  /* USER CODE END EXTI13_10_IRQn 0 */
  HAL_GPIO_EXTI_IRQHandler(USER_BUTTON_Pin);
  /* USER CODE BEGIN EXTI13_10_IRQn 1 */

  /* USER CODE END EXTI13_10_IRQn 1 */
}
