...
#ifndef FX_STM32_XSPI_MEMMAPPED_DRIVER_H
#define FX_STM32_XSPI_MEMMAPPED_DRIVER_H
...
#define FX_SRAM_DISK_BASE_ADDRESS         (XSPI2_BASE + XSPI_OFFSET_TCS_ROMFS) // Absolute Address in Memory Mapped mode
...
#endif /* FX_STM32_XSPI_MEMMAPPED_DRIVER_H */
